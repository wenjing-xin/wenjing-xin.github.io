var binft = function (r) {
    ...
    function getRandomColor() {if(isTransparent){
            isTransparent = false;
            // 此处修改字体颜色, 最后的 0 和 1 不要改
            return "rgba(90,144,224,0)" 
        }else{
            isTransparent = true;
            return "rgba(90,144,224,1)"
        }
    }  
    function n(r) {for (var n = document.createDocumentFragment(), i = 0; r > i; i++) {var oneword = document.createElement("span");
    ...
    function i() {var t = wordList[c.skillI];
    ...
    wordList = [ 
            ...
            "问世间情为何物. 直教人生死相许.",
            "轻舟已过万重山.",
            "岁月了无痕. 时光轻染故事尘. 百年光景如梦航. 笔墨留香绘干行.",
        ].map(function (r) {return r + ""}),
    showTotalWordDelayTime = 3,
    refreshDelayTime = 2,
    maxLength = 1,
    d = 75,
    c = {
